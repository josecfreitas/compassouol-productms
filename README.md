# Desafio para a empresa Compasso UOL

O desafio foi realizado utilizando Spring Boot 2.4.5, Java 11 e Maven.
...
O jar executável será criado em ./target/productms.jar

Abaixo seguem as instruções do desafio.
